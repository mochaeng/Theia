...
public enum DocumentValidationErrorCode {
    ...
    PDF_ENCRYPTED("PDF_ENCRYPTED", "PDF is password-protected and cannot be processed"),
    PDF_CORRUPTED("PDF_CORRUPTED", "PDF file is corrupted or has invalid structure"),
    ...
    VIRUS_DETECTED("VIRUS_DETECTED", "File contains malicious content and cannot be processed");
